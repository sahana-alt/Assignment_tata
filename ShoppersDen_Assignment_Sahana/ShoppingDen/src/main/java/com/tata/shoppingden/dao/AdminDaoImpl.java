...
public class AdminDaoImpl implements AdminDao{
    ...
    public void addProduct(Product product) throws SQLException {
        ...
        product_pre.setString(6,product.getProductDesc());
        product_pre.execute();
        conn.commit();
    }

    @Override
    public void deleteProduct(long pId) throws SQLException {
    ...
    public List<Customer> viewAllCustomerDetails() throws SQLException {
        ...
        String query=resourceBundle.getString("viewcustomer");
        ...
        while(resultSet.next())
        {
            ...
            cust.setPsswd(resultSet.getString(4));
            cust.setAddress(resultSet.getString(5));
            cust.setPhoneNumber(resultSet.getLong(6));
            cust.setSecQuestion(resultSet.getString(7));
            cust.setSecAnswer(resultSet.getString(8));
